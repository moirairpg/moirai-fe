...
const persona: Ref<Persona> = ref({ nudge: {}, bump: {} });
    ...
    <div class="grid">
        <div class="col-12">
            <div class="card">
                ...
                <PersonaDialog :persona="persona" :isOwner="persona.owner === '560204799925288962'" v-model:visible="visible" @onClose="hidePersonaWindow" @onSave="printPersona" @onDownload="printPersona" @onClone="printPersona" />
                <PersonaDialog :persona="persona" :isOwner="persona.owner === 'aaaaa'" v-model:visible="viewVisible" @onClose="hidePersonaViewWindow" @onSave="printPersona" @onDownload="printPersona" @onClone="printPersona" />
            </div>
        </div>
    </div>
</template>
